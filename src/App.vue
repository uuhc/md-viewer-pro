<template>
  <a-layout class="app-layout">
    ...
    <a-layout-content class="content-area">
      ...
      <div class="markdown-content-wrapper">
        ...
        <div v-else class="welcome-screen">
          ...
          <p>请从左侧文件树中选择一个 Markdown 文件进行预览</p>
        </div>
      </div>
    </a-layout-content>
    ...
    <a-layout-sider
      ...
      collapsible
      :trigger="null"
      class="sidebar-right toc-sidebar"
    >
...
const { files, currentFile, loadFiles, selectFile, addFiles, saveFiles } = useFileManager();
...
const handleExport = () => {
  if (currentFile.value) {
    exportToHTML(currentFile.value, tocItems.value, currentTheme.value);
  }
};
...
/* 确保侧边栏内容可以滚动 */
:deep(.sidebar-right .ant-layout-sider-children) {
  height: 100%;
  display: flex;
  flex-direction: column;
  overflow: hidden;
...
/* 确保隐藏时完全不占据空间 */
:deep(.sidebar-right.ant-layout-sider-collapsed) {
  width: 0 !important;
